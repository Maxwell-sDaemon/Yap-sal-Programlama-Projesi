...
/*akademisyen id sini akademisyenler.txt dosyasındaki 
 * son akademisyenden bir fazlasını alır.*/
...
/*kullanıcının girdiği değere göre ilgili stringi döner.*/
